        ...
        <div className="sign-container">
            ...
            <form onSubmit={handleSubmit}>
                <input
                    ...
                    placeholder="Email"
                    value={email}
                    onChange={(e) => setEmail(e.target.value)} // This should be fine
                    required
                />
                <input
                    type="password"
                    ...
                    value={password}
                    onChange={(e) => setPassword(e.target.value)} // This should also be fine
                    required
                />
                ...
                {!isLogin && (
                    <input
                        ...
                        required={!isLogin} // Only required in sign up
                    />
                )}
                <button type="submit">{isLogin ? 'Login' : 'Sign Up'}</button>
            </form>
            <div className="auth-options">
                <button onClick={handleGoogleAuth}><FaGoogle /> Google</button>
                <button onClick={handleGithubAuth}><FaGithub /> GitHub</button>
            </div>
            <p>
